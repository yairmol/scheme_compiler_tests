...
let const_test_suite = [
  ("test_bool", [(Const(Sexpr (Bool (true))))], Tag_Parser.tag_parse_expressions [Bool true]);
  ("test_number", [(Const(Sexpr (Number (Float(1.23)))))], Tag_Parser.tag_parse_expressions [(Number (Float(1.23)))]);
  ("test_char", [(Const(Sexpr (Char ('a'))))], Tag_Parser.tag_parse_expressions [Char ('a')]);
  ("test_string", [(Const(Sexpr (String ("hello"))))], Tag_Parser.tag_parse_expressions [String ("hello")]);
  ("test_simple_quote", [Const (Sexpr(Symbol "a"))], Tag_Parser.tag_parse_expressions [Pair (Symbol "quote", Pair (Symbol "a", Nil))]);
  ("test_complex_quote", [Const (Sexpr 
    (Pair (Symbol "a",
  ...
  ("const_test_1", Tag_Parser.tag_parse_expressions [Pair (Symbol "quote",Pair(Pair (Number (Fraction (1, 1)), Pair (Number (Fraction (2, 1)), Pair (Number (Fraction (3, 1)), Nil))),Nil))], [Const(Sexpr(Pair (Number (Fraction (1, 1)), Pair (Number (Fraction (2, 1)), Pair (Number (Fraction (3, 1)), Nil)))))]);
  ("const_test_2", Tag_Parser.tag_parse_expressions [Pair (Symbol "quote",Pair (Pair (Number (Float 1.2), Number (Float 3.4)), Nil))], [Const (Sexpr (Pair (Number (Float 1.2), Number (Float 3.4))))]);
  ("const_test_3", Tag_Parser.tag_parse_expressions [Pair (Symbol "quote",Pair(Pair(Pair (Number (Float (-0.5)),Pair (Number (Float 999.99), Pair (Number (Float (-12.1)), Nil))),Pair (Number (Float 10.),Pair (Pair (Number (Fraction (1, 1)), Number (Fraction (2, 1))), Number (Float 1.)))),Nil))], [Const(Sexpr(Pair(Pair (Number (Float (-0.5)),Pair (Number (Float 999.99), Pair (Number (Float (-12.1)), Nil))),Pair (Number (Float 10.),Pair (Pair (Number (Fraction (1, 1)), Number (Fraction (2, 1))), Number (Float 1.))))))]);
  ("const_test_4", Tag_Parser.tag_parse_expressions [Pair (Symbol "quote",Pair(Pair (Number (Float (-0.)),Pair (Number (Float 999.123),Pair (Pair (Number (Float 501.1), Number (Float 0.5)),Number (Float (-0.555))))),Nil))], [Const(Sexpr(Pair (Number (Float (-0.)),Pair (Number (Float 999.123),Pair (Pair (Number (Float 501.1), Number (Float 0.5)),Number (Float (-0.555)))))))]);
  ("const_test_5", Tag_Parser.tag_parse_expressions [Pair (Symbol "quote",Pair(Pair (Number (Float (-0.52)),Pair (Pair (Number (Float 0.5234), Number (Float (-123.4))),Number (Float (-0.535)))),Nil))], [Const(Sexpr(Pair (Number (Float (-0.52)),Pair (Pair (Number (Float 0.5234), Number (Float (-123.4))),Number (Float (-0.535))))))]);
  ("const_test_6", Tag_Parser.tag_parse_expressions [Pair (Symbol "quote", Pair (Pair (Number (Float 0.123), Nil), Nil))], [Const (Sexpr (Pair (Number (Float 0.123), Nil)))]);
  ("const_test_7", Tag_Parser.tag_parse_expressions [Pair (Symbol "quote", Pair (Pair (Char '\000', Nil), Nil))], [Const (Sexpr (Pair (Char '\000', Nil)))]);
  ("const_test_8", Tag_Parser.tag_parse_expressions [Char '\n'], [Const (Sexpr (Char '\n'))]);
  ("const_test_9", Tag_Parser.tag_parse_expressions [Pair (Symbol "quote",Pair(Pair (Number (Fraction (1, 1)),Pair (Number (Fraction (2, 1)), Pair (Number (Fraction (3, 1)), Pair (Char '\012', Nil)))),Nil))], [Const(Sexpr(Pair (Number (Fraction (1, 1)),Pair (Number (Fraction (2, 1)), Pair (Number (Fraction (3, 1)), Pair (Char '\012', Nil))))))]);
  ("const_test_10", Tag_Parser.tag_parse_expressions [Pair (Symbol "quote",Pair(Pair (Pair (Char '\t', Nil),Pair (Pair (Char '\r', Nil), Pair (Pair (Char ' ', Nil), Nil))),Nil))], [Const(Sexpr(Pair (Pair (Char '\t', Nil),Pair (Pair (Char '\r', Nil), Pair (Pair (Char ' ', Nil), Nil)))))]);
  ("const_test_11", Tag_Parser.tag_parse_expressions [Pair (Symbol "quote",Pair(Pair (String "a",Pair (String "b", Pair (Pair (String "c", String "d"), String "e"))),Nil))], [Const(Sexpr(Pair (String "a",Pair (String "b", Pair (Pair (String "c", String "d"), String "e")))))]);
  ("const_test_12", Tag_Parser.tag_parse_expressions [Pair (Symbol "quote",Pair(Pair (String "hello",Pair (String "world",Pair (Pair (Number (Float 1.2), Number (Fraction (3, 1))), Char '\000'))),Nil))], [Const(Sexpr(Pair (String "hello",Pair (String "world",Pair (Pair (Number (Float 1.2), Number (Fraction (3, 1))), Char '\000')))))]);
  ("const_test_13", Tag_Parser.tag_parse_expressions [Pair (Symbol "quote",Pair (Pair (String "should", Pair (String "be", String "list")), Nil))], [Const (Sexpr (Pair (String "should", Pair (String "be", String "list"))))]);
  ("const_test_14", Tag_Parser.tag_parse_expressions [Pair (Symbol "quote",Pair(Pair (String "vary",Pair (String "long",Pair (Number (Fraction (0, 1)),Pair (Number (Float 2.1),Pair (Number (Float (-4.2)),Pair (String "complex", Pair (Char '\r', Pair (String "list", Nil)))))))),Nil))], [Const(Sexpr(Pair (String "vary",Pair (String "long",Pair (Number (Fraction (0, 1)),Pair (Number (Float 2.1),Pair (Number (Float (-4.2)),Pair (String "complex",Pair (Char '\r', Pair (String "list", Nil))))))))))]);
  ("const_test_15", Tag_Parser.tag_parse_expressions [Pair (Symbol "quote",Pair(Pair (Symbol "a",Pair (Symbol "b",Pair (Symbol "c", Pair (Symbol "d", Pair (Symbol "f", Symbol "g"))))),Nil))], [Const(Sexpr(Pair (Symbol "a",Pair (Symbol "b",Pair (Symbol "c", Pair (Symbol "d", Pair (Symbol "f", Symbol "g")))))))]);
  ("const_test_16", Tag_Parser.tag_parse_expressions [Pair (Symbol "quote",Pair(Pair (String "a long long string",Pair (String "another long one",Pair(Pair (String "some numbers",Pair (Number (Fraction (1, 1)), Pair (Number (Fraction (2, 1)), Number (Fraction (3, 1))))),Pair (String "Named Char", Char ' ')))),Nil))], [Const(Sexpr(Pair (String "a long long string",Pair (String "another long one",Pair(Pair (String "some numbers",Pair (Number (Fraction (1, 1)), Pair (Number (Fraction (2, 1)), Number (Fraction (3, 1))))),Pair (String "Named Char", Char ' '))))))]);
  ("const_test_17", Tag_Parser.tag_parse_expressions [Pair (Symbol "quote",Pair(Pair (Number (Float (-0.2)),Pair (Number (Float 1.5),Pair(Pair (Number (Fraction (1, 1)),Pair (Number (Fraction (2, 1)), Pair (Number (Fraction (3, 1)), Nil))),Pair (Pair (Number (Fraction (4, 1)), Number (Fraction (5, 1))),Pair (Pair (Symbol "a", Pair (Symbol "b", Symbol "c")),Pair (Symbol "d", Symbol "f")))))),Nil))], [Const(Sexpr(Pair (Number (Float (-0.2)),Pair (Number (Float 1.5),Pair(Pair (Number (Fraction (1, 1)),Pair (Number (Fraction (2, 1)), Pair (Number (Fraction (3, 1)), Nil))),Pair (Pair (Number (Fraction (4, 1)), Number (Fraction (5, 1))),Pair (Pair (Symbol "a", Pair (Symbol "b", Symbol "c")),Pair (Symbol "d", Symbol "f"))))))))]);
  ("const_test_18", Tag_Parser.tag_parse_expressions [Pair (Symbol "quote",Pair(Pair (Number (Float 0.1),Pair (Number (Float (-0.2)),Pair (Number (Float 3.4),Pair (Number (Fraction (5, 1)),Pair (Number (Float 6.7), Pair (Number (Fraction (8, 1)), Number (Fraction (9, 1)))))))),Nil))], [Const(Sexpr(Pair (Number (Float 0.1),Pair (Number (Float (-0.2)),Pair (Number (Float 3.4),Pair (Number (Fraction (5, 1)),Pair (Number (Float 6.7), Pair (Number (Fraction (8, 1)), Number (Fraction (9, 1))))))))))]);
  ("const_test_19", Tag_Parser.tag_parse_expressions [Pair (Symbol "quote",Pair(Pair (Number (Fraction (1, 1)),Pair (Pair (Number (Fraction (2, 1)), Pair (Number (Fraction (3, 1)), Nil)),Pair (Pair (Number (Fraction (4, 1)), Pair (Number (Float 0.5), Nil)),Pair(Pair (Symbol "c",Pair (Symbol "d",Pair (Pair (Symbol "f", Symbol "g"), String "Hello World"))),Symbol "z")))),Nil))], [Const(Sexpr(Pair (Number (Fraction (1, 1)),Pair (Pair (Number (Fraction (2, 1)), Pair (Number (Fraction (3, 1)), Nil)),Pair (Pair (Number (Fraction (4, 1)), Pair (Number (Float 0.5), Nil)),Pair(Pair (Symbol "c",Pair (Symbol "d",Pair (Pair (Symbol "f", Symbol "g"), String "Hello World"))),Symbol "z"))))))]);
  ("const_test_20", Tag_Parser.tag_parse_expressions [String ""], [Const (Sexpr (String ""))]);
  ("const_test_21", Tag_Parser.tag_parse_expressions [Pair (Symbol "quote",Pair (Pair (Number (Float 1.2), Pair (Number (Float 3.4), Nil)), Nil))], [Const (Sexpr (Pair (Number (Float 1.2), Pair (Number (Float 3.4), Nil))))]);
  ("const_test_22", Tag_Parser.tag_parse_expressions [Pair (Symbol "quote", Pair(Pair (Pair (Char '\t', Nil), Pair (Pair (Char '\r', Nil), Pair (Pair (Char ' ', Nil), Char '\000'))),Nil))], [Const(Sexpr(Pair (Pair (Char '\t', Nil), Pair (Pair (Char '\r', Nil), Pair (Pair (Char ' ', Nil), Char '\000')))))]);
];;
