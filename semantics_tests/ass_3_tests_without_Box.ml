   ...
   LambdaSimple' (["y"],
     ...
     ApplicTP' (Var' (VarFree "+"),
      [Var' (VarParam ("x", 0)); Var' (VarParam ("y", 1));
       Var' (VarParam ("z", 2))])])));
("test1", ( (LambdaSimple (["x"], Set (Var "x", Applic (LambdaSimple ([], Var "x"), [])))) ), (
LambdaSimple' (["x"],
   Set' (VarParam ("x", 0),
...
("test6", ( (If (Var "x", Applic (Var "x", []), Var "x")) ), (
...
("test9", ( (LambdaSimple (["x"],
  Seq [Applic (Var "x", []); Set (Var "x", Applic (Var "x", []))])) ), (
LambdaSimple' (["x"],
 Seq'
  [Applic' (Var' (VarParam ("x", 0)), []);
   Set'( (VarParam ("x", 0)), Applic' (Var' (VarParam ("x", 0)), []))])));
("test10", ( (LambdaSimple ([], Const (Sexpr (Number (Fraction(1,1)))))) ), (LambdaSimple' ([], Const' (Sexpr (Number (Fraction(1,1)))))));
("test11", ( (LambdaSimple (["x"],
  Applic
   (LambdaSimple (["y"],
...
LambdaSimple' (["x"],
 ApplicTP'
  ...
  []))));
("test12", ( (Const(Void)) ), ( Const' Void));
("test13", ( (LambdaSimple (["x"],
  Seq
   [Var "x";
    LambdaSimple (["x"],
     Seq
...
LambdaSimple' (["x"; "y"],
 Or'
  [Applic' (Var' (VarFree "f"),
    [Applic' (Var' (VarFree "g"), [Var' (VarParam ("x", 0))])]);
   Var' (VarParam ("y", 1))])));
("test23", ( (LambdaSimple (["x"], Set (Var "x", Applic (Var "f", [Var "y"])))) ), (
LambdaSimple' (["x"],
 Set'( (VarParam ("x", 0)),
  ...
  If' (Applic' (Var' (VarFree "g?"), [Var' (VarParam ("x", 0))]),
   ...
   Seq'
    [Applic' (Var' (VarFree "h"), [Var' (VarParam ("x", 0))]);
     ...
     ApplicTP' (Var' (VarFree "g"),
      [Applic' (Var' (VarFree "f"), [Var' (VarParam ("x", 0))])])])))));
("test26", ( (Applic (LambdaSimple (["x"; "y"], Applic (Var "+", [Var "x"; Var "y"])),
...
("test28", ( (LambdaSimple (["x"; "y"; "z"], Applic (Var "+", [Var "x"; Var "y"; Var "z"]))) ), (
LambdaSimple' (["x"; "y"; "z"],
 ApplicTP' (Var' (VarFree "+"),
  [Var' (VarParam ("x", 0)); Var' (VarParam ("y", 1));
   Var' (VarParam ("z", 2))]))));
("test29", ( (LambdaSimple (["x"; "y"; "z"],
 Applic (Var "+",
  [Var "x"; Var "y";
   LambdaSimple (["z"],
...
Def' ( (VarFree "x"),
 Applic' (Var' (VarFree "+"),
  [Const' (Sexpr (Number (Fraction(1,1)))); Const' (Sexpr (Number (Fraction(2,1))))]))));
("test53", ( (LambdaOpt (["x"], "y", Var "x")) ), ( LambdaOpt' (["x"], "y", Var' (VarParam ("x", 0)))));
("test54", ( (If (Applic (LambdaSimple (["y"], Var "x"), []),
  Applic
   (LambdaSimple (["x"],
     Seq
      [Set (Var "x", Var "y");
...
LambdaSimple' (["x"; "y"; "z"; "a"; "b"],
 If'
  ...
  If' (Applic' (Var' (VarFree "f"), [Var' (VarParam ("x", 0))]),
   ...
   Const' (Sexpr (Bool false))),
  ApplicTP' (Var' (VarFree "h"), [Var' (VarParam ("z", 2))])))));
("test62", ( (LambdaSimple (["s"], Applic (Var "apply", [Var "f"; Var "s"]))) ), (
LambdaSimple' (["s"],
